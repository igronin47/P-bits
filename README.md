 **GPU_CPU_Framework:**
 The framework supports Numpy, CuPy and CUDA with parallel solver for GPU Acceleration. For enabling this, please using GPU_CPU_Framework branch, this is not pushed in main branch.
